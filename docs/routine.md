# Daily Briefings — the routine that builds this site
# This is the live prompt of the scheduled agent run that researches, builds, and
# publishes https://karlarao.github.io/daily-briefings/claude.html once a day.
# Lightly redacted: one private post-publish step (a second, non-public
# deliverable) is omitted.
...
0. BOOTSTRAP. The VM boots with the repo cloned & GitHub-App-authenticated. Prepare it:
   ...
   (Pages serves the gh-pages root; index.html + codex.html already live there and
    are left untouched. The public dashboard publishes via git.)
